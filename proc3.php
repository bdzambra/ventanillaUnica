...
?>							<label> NO EXISTE </label>
							<INPUT TYPE="submit" NAME="Boton" VALUE="AGREGAR USUARIO" onclick="agregarusuario1(<?php echo $q=0; ?>)"></br>
<?php		}
			else
			{
?>							
							<select style='font-size:12px;' onchange="autocompletar1(this.value)">
