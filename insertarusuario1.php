...
$nombrepatrocinador=$_POST['nombrepatrocinador1'];
$correonotificacion=$_POST['correonotificacion1'];
$celularnotificacion=$_POST['celularnotificacion1'];
$telefononotificacion=$_POST['telefononotificacion1'];
$rucrepre=$_POST['rucrepre'];
$nombrefuncionario=$_POST['nombrefuncionario'];

$con=conexion2();
$res=pg_query($con,"INSERT INTO usuario(nombreempresa, ruc, nombrerepresentante, correo, celular, telefono, correonotificacion, nombrepatrocinador, celularnotificacion, telefononotificacion, cedularepresentante,fecha,registrador) VALUES ('$razon', '$ruc', '$nombre', '$correo', '$celular', '$telefono', '$correonotificacion', '$nombrepatrocinador', '$celularnotificacion', '$telefononotificacion', '$rucrepre','now()','$nombrefuncionario');");
pg_close($con);

$con=conexion();
$res=pg_query($con,"INSERT INTO usuario(nombreempresa, ruc, nombrerepresentante, correo, celular, telefono, correonotificacion, nombrepatrocinador, celularnotificacion, telefononotificacion, cedularepresentante, fecha, registrador) VALUES ('$razon', '$ruc', '$nombre', '$correo', '$celular', '$telefono', '$correonotificacion', '$nombrepatrocinador', '$celularnotificacion', '$telefononotificacion', '$rucrepre','now()','$nombrefuncionario');");
$res=pg_query($con,"INSERT INTO usuariohistorico(nombreempresa, ruc, nombrerepresentante, correo, celular, telefono, correonotificacion, nombrepatrocinador, celularnotificacion, telefononotificacion, cedularepresentante,fecha,registrador) VALUES ('$razon', '$ruc', '$nombre', '$correo', '$celular', '$telefono', '$correonotificacion', '$nombrepatrocinador', '$celularnotificacion', '$telefononotificacion', '$rucrepre','now()','$nombrefuncionario');");
    ...
    <div class="col-sm-16 col-md-16">
        <?php 
            ...
            ?>
                ...
                <div><input type = "button" value = "Modificar" onclick = "modificarusuario1('<?php echo $row[1]; ?>')"></div>
                <div><input type = "button" value = "Agregar" onclick = "agregarusuariotramite1('<?php echo $row[1]; ?>')"></div>
                </div>
            <?php
            }
        ?>
